                              ...
                              <?php foreach ($data_edit as $data) { ?>
                                  <form class="cmxform form-horizontal tasi-form" method="post" action="<?php echo base_url().'/user/update' ?>">
                                     ...
                                     <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="tempat_lahir" name="tempat_lahir" type="text" required value="<?php echo $data->tempat_lahir ?>" />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="password" class="control-label col-lg-2">Tanggal Lahir</label>
                                          <div class="col-lg-10">
                                              <input class="form-control " id="tanggal_lahir" name="tanggal_lahir" type="text" required value="<?php echo $data->tanggal_lahir ?>"/>
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="telp" name="telp" type="text" required value="<?php echo $data->telp ?>"/>
                                          </div>
                                      </div>
